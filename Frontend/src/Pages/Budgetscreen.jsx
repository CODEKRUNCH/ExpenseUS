...
// Modal Component
const CreateBudgetModal = ({ onClose, onSave }) => {
    ...
    const categories = ['Food & Drinks', 'Transportation', 'Utilities', 'Rent', 'Entertainment', 'Shopping'];
    ...
    const handleSubmit = (e) => {
        ...
        const newBudgetData = {
            name: budgetName,
            budgetLimit: budgetAmount, // budgetLimit corresponds to the "Amount" field
            period: budgetPeriod,
            wallet: budgetWallet,
            totalSpent: 0, // New budgets start with 0 spent
        };
        onSave(newBudgetData); // Pass the collected data to the onSave prop
        ...
        <div className="flex bg-[#080F25] min-h-screen text-white">
            ...
            <div className={`flex-1 p-6 transition-all duration-300 ${isSidebarOpen ? 'ml-[200px]' : 'ml-0'}`}>
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                    ...
                    <button
                        className="mt-4 md:mt-0 bg-[#A33AFF] text-white px-4 py-2 rounded-md font-bold hover:bg-purple-700"
            ...
            {showModal && <CreateBudgetModal onClose={() => setShowModal(false)} onSave={handleAddBudget} />}
        </div>
    );
};
